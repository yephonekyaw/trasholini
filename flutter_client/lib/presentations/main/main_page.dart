// presentations/mainpage/main_page.dart
...
class MainPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // 🔥 FIREBASE INTEGRATION POINT 8: WATCH ASYNC DATA
    final categoriesAsync = ref.watch(categoriesProvider);
    final wasteBinsAsync = ref.watch(userSelectedBinsProvider); // Use user's selected bins
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // 🔥 FIREBASE INTEGRATION POINT 9: HANDLE ASYNC WASTE BINS
            wasteBinsAsync.when(
