...
class NearbyBinsMapSection extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<NearbyBinsMapSection> createState() =>
      _NearbyBinsMapSectionState();
}
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(bin['icon'], color: bin['color'], size: 16),
          ),
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Icon(bin['icon'], color: bin['color'], size: 24),
                    ),
